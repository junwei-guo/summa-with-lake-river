MODULE globalData_mizuRoute
  ...
  USE var_lookup_route, ONLY: nStructures
  USE var_lookup_route, ONLY: nDimensions
  USE var_lookup_route, ONLY: nStateDims
  USE var_lookup_route, ONLY: nQdims
  USE var_lookup_route, ONLY: nVarsHRU
  USE var_lookup_route, ONLY: nVarsHRU2SEG
  USE var_lookup_route, ONLY: nVarsSEG
  USE var_lookup_route, ONLY: nVarsNTOPO
  USE var_lookup_route, ONLY: nVarsPFAF
  USE var_lookup_route, ONLY: nVarsRFLX
  USE var_lookup_route, ONLY: nVarsIRFbas
  USE var_lookup_route, ONLY: nVarsBasinQ
  USE var_lookup_route, ONLY: nVarsIRF
  USE var_lookup_route, ONLY: nVarsKWT
  USE var_lookup_route, ONLY: nVarsKW
  USE var_lookup_route, ONLY: nVarsDW
  USE var_lookup_route, ONLY: nVarsMC
