module popMetadat_module_mizuroute
...
USE var_lookup_route, only : ixStruct   , nStructures   ! index of variables for data structure
USE var_lookup_route, only : ixDims     , nDimensions   ! index of variables for data structure
USE var_lookup_route, only : ixStateDims, nStateDims    ! index of variables for data structure
USE var_lookup_route, only : ixQdims    , nQdims        ! index of variables for data structure
USE var_lookup_route, only : ixHRU      , nVarsHRU      ! index of variables for data structure
USE var_lookup_route, only : ixHRU2SEG  , nVarsHRU2SEG  ! index of variables for data structure
USE var_lookup_route, only : ixSEG      , nVarsSEG      ! index of variables for data structure
USE var_lookup_route, only : ixNTOPO    , nVarsNTOPO    ! index of variables for data structure
USE var_lookup_route, only : ixPFAF     , nVarsPFAF     ! index of variables for data structure

USE var_lookup_route, only : ixRFLX                     ! index of variables for data structure
USE var_lookup_route, only : ixKWT                      ! index of variables for data structure
USE var_lookup_route, only : ixKW                       ! index of variables for data structure
USE var_lookup_route, only : ixDW                       ! index of variables for data structure
USE var_lookup_route, only : ixMC                       ! index of variables for data structure
USE var_lookup_route, only : ixIRF                      ! index of variables for data structure
USE var_lookup_route, only : ixIRFbas                   ! index of variables for data structure
USE var_lookup_route, only : ixBasinQ                   ! index of variables for data structure
...
END MODULE popMetadat_module_mizuroute
