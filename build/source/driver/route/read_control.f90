...
CONTAINS
 ...
 USE var_lookup_route, ONLY: ixHRU
 USE var_lookup_route, ONLY: ixHRU2SEG
 USE var_lookup_route, ONLY: ixSEG
 USE var_lookup_route, ONLY: ixNTOPO
 USE var_lookup_route, ONLY: ixPFAF
 USE var_lookup_route, ONLY: ixRFLX
