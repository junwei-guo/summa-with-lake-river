...
! named variables
USE var_lookup_route, ONLY: ixSEG                  ! index of variables for the stream segments
USE var_lookup_route, ONLY: ixNTOPO                ! index of variables for the network topology
