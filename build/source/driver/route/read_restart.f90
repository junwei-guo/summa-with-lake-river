...
USE nrtype_mizuroute, only: i4b, dp, strLen
USE public_var
...
CONTAINS
 ...
 USE var_lookup_route, ONLY: ixStateDims, nStateDims
 ...
 CONTAINS
  ...
  SUBROUTINE read_basinQ_state(ierr, message1)
    ...
    USE var_lookup_route, ONLY: ixBasinQ, nVarsBasinQ
    implicit none
    ! output
    integer(i4b), intent(out)     :: ierr           ! error code
  ...
  SUBROUTINE read_IRFbas_state(ierr, message1)
    ...
    USE var_lookup_route, ONLY: ixIRFbas, nVarsIRFbas
    implicit none
    ! output
    integer(i4b), intent(out)     :: ierr           ! error code
    character(*), intent(out)     :: message1       ! error message
  ...
  SUBROUTINE read_IRF_state(ierr, message1)
    ...
    USE var_lookup_route,  ONLY: ixIRF, nVarsIRF
    implicit none
    integer(i4b), intent(out)     :: ierr           ! error code
    character(*), intent(out)     :: message1       ! error message
    ! local variables
  ...
  SUBROUTINE read_KWT_state(ierr, message1)
    ...
    USE var_lookup_route, ONLY: ixKWT, nVarsKWT
    implicit none
    integer(i4b), intent(out)     :: ierr           ! error code
    character(*), intent(out)     :: message1       ! error message
    ! local
  ...
  SUBROUTINE read_KW_state(ierr, message1)
    ...
    USE var_lookup_route, ONLY: ixKW, nVarsKW
    implicit none
    integer(i4b), intent(out)     :: ierr           ! error code
    character(*), intent(out)     :: message1       ! error message
    ! local variables
  ...
  SUBROUTINE read_MC_state(ierr, message1)
    ...
    USE var_lookup_route, ONLY: ixMC, nVarsMC
    implicit none
    integer(i4b), intent(out)     :: ierr           ! error code
    character(*), intent(out)     :: message1       ! error message
    ! local variables
  ...
  SUBROUTINE read_DW_state(ierr, message1)
    ...
    USE var_lookup_route, ONLY: ixDW, nVarsDW
    implicit none
    integer(i4b), intent(out)     :: ierr           ! error code
    character(*), intent(out)     :: message1       ! error message
    ! local variables
