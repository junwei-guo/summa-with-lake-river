...
# build SUMMA on a Fedora linux using Bash, from cmake directory run this as ./build.fedora.linux.bash
...
export FC=/usr/bin/gfortran                             # Fortran compiler family
